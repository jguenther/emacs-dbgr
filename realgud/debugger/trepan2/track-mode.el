...
(realgud-track-mode-vars "realgud:trepan2")

(realgud-python-populate-command-keys realgud:trepan2-track-mode-map)

(defun realgud:trepan2-track-mode-hook()
  (if realgud:trepan2-track-mode
      (progn
	(use-local-map realgud:trepan2-track-mode-map)
...
(define-minor-mode realgud:trepan2-track-mode
...
\\{realgud:trepan2-track-mode-map}
"
  :init-value nil
  ...
  :keymap realgud:trepan2-track-mode-map

  (realgud:track-set-debugger "trepan2")
  (if realgud:trepan2-track-mode
      (progn
	(realgud-track-mode-setup 't)
        (realgud:trepan2-track-mode-hook))
    (progn
      (setq realgud:realgud-track-mode nil)
      ))
  )

(define-key realgud:trepan2-short-key-mode-map "T" 'realgud:cmd-backtrace)
